...
namespace PD1S3Z_HFT_2021221.Test
{
    ...
    public class BookTests
    {
        ...
        [Test]
        public void GetBooksByBorrower()
        {
            Mock<IBookRepository> libraryRepo = new Mock<IBookRepository>();

            List<Book> books = new List<Book>()
            {
                new Book() { Title = "book1", BorrowerId = 1 },
                new Book() { Title = "book2", BorrowerId = 2 },
                new Book() { Title = "book3", BorrowerId = 2 },
                new Book() { Title = "book4", BorrowerId = 1 },
                new Book() { Title = "book5", BorrowerId = 2 },
                new Book() { Title = "book6", BorrowerId = 1 }
            };
            ...
            var result = logic.GetBooksByBorrowerId(2);
